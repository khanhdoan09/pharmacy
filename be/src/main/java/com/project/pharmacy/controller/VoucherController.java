...
public class VoucherController {
    ...
    public ResponseHandler<List<VoucherDto>> findAllVouchersByBeginningDateBetweenAndExpirationDate(
        ...
        List<Voucher> vouchers =
                voucherService.findAllByBeginningDateGreaterThanEqualAndExpirationDateLessThanEqual(
                        beginningDate,
                        expirationDate);
